...
^[{-} `r blogdown::shortcode("courseinfo")`] <span class="newthought">This site contains</span> the syllabus, schedule, and assignments for ECON 306: Microeconomic Analysis, held during Spring 2020 at Hood College.

# <i class="fas fa-exclamation-circle"></i> Transition to Online (COVID-19)
...
**Last Update**: [`r format(Sys.time(), "%X %a %b %d %Y")`](https://github.com/ryansafner/microS20/commits/master)
