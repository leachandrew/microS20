...
Answers to last class' practice problems (on elasticities) are [posted on that page](/practice/1.7-practice). There are no official practice problems for today, but you should **try to draw** the full (real) income and substitution effects graph for a price change (for a normal good) on your own!
