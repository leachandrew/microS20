...
- .hi[Optimization]: which action(s) best achieve an *objective*? 
...
- Find the *optimum* using .hi-purple[marginal analysis]
]
...
- .hi[Equilibrium]: how do stable outcomes emerge in the world (and change)? 
...
- Find the outcome where *no agents change their behavior* using .hi-purple[supply and demand]
]
...
- .hi[Game Theory]: what outcome will we *jointly* reach if our choices are **strategic**?
