...
- .hi-purple[Competition] from *other* sellers drives prices down to match $MC(q)$ (and pushes costs and economics rents upwards)
...
# Lerner Index and Inverse Elasticity Rule I

.pull-left[
.smaller[
- Perfect competition: $p=MC(q)$ (allocatively efficient)

- .hi-purple[Market power] $\implies$ firms can .hi-purple[mark up] $p>MC(q)$

- .hi-purple[Size of markup depends on **price elasticity of demand**]
  - $\downarrow$ price elasticity: $\uparrow$ markup
  - i.e. the *less* responsive to prices consumers are, the *higher* firm can charge
]
]
...
# The Lerner Index and Inverse Elasticity Rule III
