...
- .hi[real income effect]: a change in the price of $x$ changes your .hi-purple[real income] or .hi-purple[purchasing power], the amount of goods you can buy
...
- .hi[substitution effect]: consumption changes because of a change in **relative prices**
...
- .hi[Real income effect]: change in consumption due to change in real purchasing power
...
- .hi[Substitution effect]: change in consumption due to change in relative prices
...
- Exception in the theoretical .hi[Giffen good]: negative R.I.E. $>$ S.E.
...
- Vertical intercept called the .hi["Choke price"]: price where $q_D=0$ ($10), just high enough to discourage *any* purchases
...
- A change in one of the .hi-purple["determinants of demand"] (or "shifters") will shift the demand curve
    - Change in income $m$
