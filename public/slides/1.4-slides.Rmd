...
- Any **"good balance"** of the two goods (e.g. $C) \succ$ "unbalanced" $(A$ or $B)$

- .hi-purple[People prefer variety in consumption]

- Math: **convex function** $\implies$ line connecting 2 points lies *above* function
