...
3. .hi[Transitivity] : rankings are logically consistent:
...
- Typical in economics: .hi-purple[very often yes, sometimes no!]

- See .hi[Behavioral economics] for interesting anomalies and exceptions
]

.pull-right[
.center[
![](https://www.dropbox.com/s/csipcxumy546cf1/behavioralecon.png?raw=1)
]
]
...
- .hi-blue[Indifferent] between all apts on the same curve
...
.pull-left[
- .hi-purple[We can always draw indifference curves]: two bundles can always be ranked
...
.pull-left[
- .hi-purple[Monotonic]: "more is preferred to less"
...
- .hi-purple[Convex]: "averages are preferred to extremes"

- Take a (weighted) average of any two apartments on curve

- Any "good balance" of the two goods (e.g. $C) \prec$ "unbalanced" $(A$ or $B)$

- Observation: people prefer variety in consumption

- Mathematically: **convex** $\implies$ a line connecting two points on function lies *above* the function
