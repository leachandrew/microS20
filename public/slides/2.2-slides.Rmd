...
.pull-left[
- The .hi[marginal product] of an input is the *additional* output produced by *one more unit* of that input (*holding other inputs constant*)
...
.center[
![:scale 70%](https://www.dropbox.com/s/38uytjucjnxsjwu/minwagerobot.jpg?raw=1)
]
]
...
.center[
![:scale 35%](https://www.dropbox.com/s/860tndrzl6zdxs2/shortageofrobots.jpg?raw=1)
]
]
